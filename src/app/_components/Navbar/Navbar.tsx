...
signOut({
  ...
  return (
    <nav className="bg-black text-yellow-400 fixed w-full z-50 start-0 top-0 end-0 mb-8">
...
<div
  className={`
    fixed top-0 left-0 h-full w-64 bg-black text-yellow-400  
...
>
          <div className="left ">
            ...
            <li><Link href="/register"  onClick={closeMenu}>Register</Link></li>
              ...
              <>            <li className='cursor-pointer' onClick={logout} >  signOut</li>
